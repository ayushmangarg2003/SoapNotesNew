...
const features = [
    ...
    description: (
      <>
        <ul className="space-y-1">
          {[
            "Real-Time Capturing",
            "Automated scribing enhances efficiency and accuracy",
            "Simplifies the process of approving and releasing summaries",
          ].map((item) => (
    ...
    description: (
      <>
        <ul className="space-y-2">
          {[
            "Actively addresses and mitigates claim denials.",
            "AI streamlines coding and claim submission processes",
            "Reduces the need for manual back-and-forth communication",
          ].map((item) => (
            <li key={item} className="flex items-center gap-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <>
        <ul className="space-y-2">
          {[
            ...
            "System learns usage patterns for each appointment.",
            "Automatic Reorders",
            "Simplifies inventory management for efficiency",
          ].map((item) => (
            <li key={item} className="flex items-center gap-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
  ...
  },
  {
    ...
    description: (
      <>
        <ul className="space-y-2">
          {["Customizable add-ons designed for specialty practices",
            "Broad range of features to meet specific automation needs",
            "Easily adapt the system to fit unique practice requirements",
            "Optimizes workflow for various specialty fields",
          ].map(
            (item) => (
              <li key={item} className="flex items-center gap-3">
                <svg
  ...
  },
  {
    ...
    description: (
      <>
        <ul className="space-y-2">
          {[
            "Sends reminders to high-risk patients for office visits",
            "Utilizes AI for effective follow-up management",
            "Automatically messages patients with care instructions.",
            "Provides follow-up consultation details seamlessly",
          ].map((item) => (
            <li key={item} className="flex items-center gap-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-base-100 max-md:px-8 max-w-3xl">
          ...
          <h2 className="font-extrabold text-3xl lg:text-5xl tracking-tight mb-8">
            ...
            EHR platform that automates your entire workflow
          </h2>
          <div className="text-base-content/80 leading-relaxed mb-8 lg:text-lg">
            {/* 💡 COPY TIP: Explain how your product delivers what you promise in the headline. */}
            Through ambient listening, our AI-powered scribing solution captures and summarizes your patient encounters in real-time. Dictation-based edits available before approval and release.
          </div>
        </div>
      </div>
